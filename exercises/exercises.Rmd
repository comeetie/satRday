...
```{block, box.title = "2", box.body = list(fill = "white"), box.icon = "fa-star"}
With the help of `cartography` package, make the following map which contains in a choropleth layer the variable *nb_rest_10000inhab* and in a proportional circle layer the variable *nb_of_rest*. If you prefer you may also try using the `ggplot2` package.
```
