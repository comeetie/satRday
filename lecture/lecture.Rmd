...
Two other packages `mapdeck` and `leafgl` deserve attention since they enable mapdrawing in webgl and therefore can be used with large datasets. They are not introduced here but keep thme in minds if needed.
